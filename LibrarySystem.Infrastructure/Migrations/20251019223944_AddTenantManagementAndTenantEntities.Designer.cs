...
namespace LibrarySystem.Infrastructure.Migrations
{
    ...
    [Migration("20251019223944_AddTenantManagementAndTenantEntities")]
    partial class AddTenantManagementAndTenantEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibrarySystem.Domain.Entities.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("UseSeparateDatabase")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("LibrarySystem.Domain.Entities.TenantFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LibrarySystem.Domain.Entities.Library", b =>
                {
                    b.HasOne("LibrarySystem.Domain.Entities.OrganizationUnit", null)
                        .WithMany("Libraries")
            ...
            modelBuilder.Entity("LibrarySystem.Domain.Entities.Tenant", b =>
                {
                    b.HasOne("LibrarySystem.Domain.Entities.OrganizationUnit", "OrganizationUnit")
                        .WithOne()
                        .HasForeignKey("LibrarySystem.Domain.Entities.Tenant", "OrganizationUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LibrarySystem.Domain.Entities.TenantFeature", b =>
                {
                    b.HasOne("LibrarySystem.Domain.Entities.Tenant", "Tenant")
                        .WithMany("Features")
